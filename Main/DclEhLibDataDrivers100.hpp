...
// (DO NOT EDIT: machine generated header) 'Dclehlibdatadrivers100.pas' rev: 10.00

#ifndef Dclehlibdatadrivers100HPP
#define Dclehlibdatadrivers100HPP
...
#include <Ibxdatadriverdesigneh.hpp>	// Pascal unit
#include <Adodatadriverdesigneh.hpp>	// Pascal unit
#include <Dbxdatadriverdesigneh.hpp>	// Pascal unit
#include <Bdedatadriverdesigneh.hpp>	// Pascal unit
...
#include <Adoreg.hpp>	// Pascal unit
#include <Sqlexpr.hpp>	// Pascal unit
#include <Dbtables.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Dclehlibdatadrivers100
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclehlibdatadrivers100 */
using namespace Dclehlibdatadrivers100;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Dclehlibdatadrivers100
