...
// (DO NOT EDIT: machine generated header) 'Adodatadriverdesigneh.pas' rev: 10.00
...
public:
	...
	#pragma option push -w-inl
	/* virtual class method */ virtual AnsiString __fastcall GetDBServiceName() { return GetDBServiceName(__classid(TADOUniService)); }
	#pragma option pop
