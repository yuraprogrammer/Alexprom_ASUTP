...
// (DO NOT EDIT: machine generated header) 'Dbgrideh.pas' rev: 10.00
...
protected:
	...
	virtual bool __fastcall DefaultMoveRecords(TCustomDBGridEh* AGrid, Classes::TStrings* BookmarkList, int ToRecNo, bool CheckOnly);
	...
	virtual bool __fastcall MoveRecords(TCustomDBGridEh* AGrid, Classes::TStrings* BookmarkList, int ToRecNo, bool CheckOnly);
...
protected:
	...
	virtual bool __fastcall HighlightNoDataCellColor(TCustomDBGridEh* AGrid, int ACol, int ARow, int DataCol, int DataRow, TCellTypeEh CellType, Gridseh::TGridDrawState AState, bool InMultiSelect, Graphics::TColor &AColor, Graphics::TFont* AFont);
	void __fastcall RemoveAllChangeNotification(void);
...
protected:
	...
	virtual bool __fastcall HighlightNoDataCellColor(int ACol, int ARow, int DataCol, int DataRow, TCellTypeEh CellType, Gridseh::TGridDrawState AState, bool InMultiSelect, Graphics::TColor &AColor, Graphics::TFont* AFont);
	...
	virtual bool __fastcall MoveDataRows(Classes::TStrings* BookmarkList, int ToIndex, int TreeLevel, bool CheckOnly);
	...
	DYNAMIC void __fastcall DrawDataCell(const Types::TRect &Rect, Db::TField* Field, Gridseh::TGridDrawState State);
	virtual void __fastcall DrawSubTitleCell(int ACol, int ARow, int DataCol, int DataRow, TCellTypeEh CellType, const Types::TRect &ARect, Gridseh::TGridDrawState AState, bool &Highlighted);
...
public:
	...
	virtual bool __fastcall DefaultMoveDataRows(Classes::TStrings* BookmarkList, int ToRecNo, int TreeLevel, bool CheckOnly);
...
#define ColumnEhTitleValues (Set<TColumnEhValue, cvColor, cvBiDiMode> () << TColumnEhValue(5) << TColumnEhValue(6) << TColumnEhValue(7) << TColumnEhValue(8) << TColumnEhValue(9) << TColumnEhValue(10) << TColumnEhValue(11) << TColumnEhValue(12) )
