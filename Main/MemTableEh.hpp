...
// (DO NOT EDIT: machine generated header) 'Memtableeh.pas' rev: 10.00
...
protected:
	#pragma option push -w-inl
	/* virtual class method */ virtual void __fastcall CheckTypeSize(int Value) { CheckTypeSize(__classid(TRefObjectField), Value); }
	#pragma option pop
