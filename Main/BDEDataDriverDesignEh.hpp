...
// (DO NOT EDIT: machine generated header) 'Bdedatadriverdesigneh.pas' rev: 10.00
...
public:
	...
	/* virtual class method */ virtual AnsiString __fastcall GetDBServiceName() { return GetDBServiceName(__classid(TBDEUniService)); }
	#pragma option pop
