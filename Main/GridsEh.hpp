...
// (DO NOT EDIT: machine generated header) 'Gridseh.pas' rev: 10.00
...
private:
	...
	TRCRRec __fastcall SetDataDrawOriginClipRegion(int StartX, int StartY, int StopX, int StopY);
	void __fastcall RestoreDataDrawOriginClipRegion(TRCRRec &RCR);
...
protected:
	...
	void __fastcall SmoothOffsetData(int DX, int DY);
